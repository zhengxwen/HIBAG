...
public:
	...
	inline TGenoStruct_512bw(const size_t Num_SNP, const TGenotype &G)
	{
		init(Num_SNP, G);
...
static ALWAYS_INLINE bool hamm_d_min_zero(const TGenoStruct_512bw &G,
	const THaplotype &H)
{
	if (G.Low64b)
	{
...
{
	const TGenoStruct_512bw GS(Num_SNP, Geno);
