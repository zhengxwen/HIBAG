...
The multi-threaded implementation can be enabled by specifying the number of threads via `nthread` in the function `hlaAttrBagging()`, or `hlaParallelAttrBagging(cl=nthread, ...)`. Here are the performance:

```{r echo=FALSE,warning=FALSE,fig.align='center',fig.width=9,fig.height=3.2}
s <- "HLAgenes	1thread	8threads	16threads	1thread	8threads	16threads
HLA-A	1.0	7.0	12.0	1.3	8.7	14.3
HLA-B	1.0	7.7	14.5	1.7	12.1	22.1
HLA-C	1.0	7.0	12.2	1.6	10.3	17.0
HLA-DRB1	1.0	7.2	12.9	1.6	10.8	18.6
HLA-DQA1	1.0	5.4	7.7	1.8	7.8	10.0
HLA-DQB1	1.0	6.4	10.3	1.7	9.5	13.8"
